sap.ui.define([
    ...
    function (Controller, History, JSONModel, Constants, LoginDB) {
        "use strict";

        return Controller.extend("tmp_demo.controller.BaseController", {
            onInit: function () {
            ...
            doLogout: function () {
                var that = this;
                LoginDB.logout(0).then(function (oData) {
                    if (oData) {
